...
class HealthChecker:
    ...
    def check_system_resources(self) -> HealthCheckResult:
        ...
        try:
            ...
            if cpu_percent > 90 or memory_percent > 90 or load_avg_5min > psutil.cpu_count():
                status = HealthStatus.UNHEALTHY
                message = "Critical: High resource utilization"
            elif cpu_percent > 70 or memory_percent > 70 or load_avg_5min > psutil.cpu_count() * 0.7:
                status = HealthStatus.DEGRADED
    ...
    def _log_health_results(self, results: Dict[str, HealthCheckResult], overall_status: HealthStatus):
...
def create_health_check_endpoint(health_checker: HealthChecker, **kwargs) -> Dict[str, Any]:
    """
