...
def databricks_parallel_extraction_example():
    ...
    total = len(results)
    print(f"Databricks parallel extraction completed: {successful}/{total} tables successful")
...
def databricks_config_file_example():
    ...
    try:
        table_configs = config_manager.load_table_configs_from_json("examples/databricks_tables.json")
        ...
        print("Databricks tables configuration file not found (this is expected for the example)")
...
def main():
    ...
    print("Ensure you have Oracle connectivity and appropriate Databricks permissions.\n")
